...
public class BillingService : IBillingService
{
    ...
    public RateConfig GetCurrentRate(bool isGaming = false)
    {
        ...
        {
            Log.Warning(ex, "Failed to get current rate, returning default rate");
    ...
    public decimal CalculatePrintCost(int pages, bool isColor)
    {
        ...
        {
            Log.Error(ex, "Failed to calculate print cost for {Pages} pages, IsColor={IsColor}", pages, isColor);
            throw;
        }
    }
